...
7050 RETURN
8000 REM LEITURA
8010 CLS : PRINT"PREPARE 0 GRAVADOR E PRESS. <ENTER>" : PRINT "OU PRESS. <C> E <ENTER> P/ DESISTIR": GOSUB 500 : IF R$ <>"" THEN RETURN
...
8070 RETURN
9000 REM GRAVACAO
9010 CLS : PRINT"PREPARE 0 GRAVADOR E PRESS. <ENTER>" : PRINT "OU PRESS. <C> E <ENTER> P/ DESISTIR": GOSUB 500 : IF R$ <>"" THEN RETURN
