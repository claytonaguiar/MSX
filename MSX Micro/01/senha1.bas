...
311 REM ADENDO: DICA DE CONTROLES
312 REM ADDENDUM: TIP FOR CONTROLS
314 DRAW "BM10,176": PRINT #1,"SPC=PICK L=TEST"
320 REM 
...
661 REM ADENDO, POR PROBLEMAS DE TIMING EM UM TURBO-R
662 REM ADDENDUM, FOR TIMING ISSUES ON TURBO-R
665 FOR TE=1TO1000:NEXT
670 NEXT I
680 Y = 50: CP = 1
690 REM
700 P = STICK (0)
...
760 I$ = INKEY$
761 REM EDITS: TROCA V POR ESPACO - CHANGE V FOR SPACE, L CASE INSENSITIVE
770 IF I$ = " " THEN C = POINT(X1+3,50) : BEEP : GOTO 810
780 IF I$ = "L" OR I$ = "l" THEN BEEP: BEEP: GOTO 930
781 REM DELAY AUMENTADO X10, POR PROBLEMAS DE TIMING EM UM TURBO-R
782 REM INCREASED DELAY X10, FOR TIMING ISSUES ON TURBO-R
790 FOR TEMPO = 1 TO 500: NEXT TE
800 GOTO 700
810 P = STICK (0)
...
870 I$ = INKEY$
880 IF I$ = " " THEN BEEP: GOTO 920
890 IF I$ = "L" OR I$ = "l" THEN BEEP: BEEP: GOTO 930
891 REM DELAY AUMENTADO X10, POR PROBLEMAS DE TIMING EM UM TURBO-R
892 REM INCREASED DELAY X10, FOR TIMING ISSUES ON TURBO-R
900 FOR TEMPO = 1 TO 500: NEXT TE
910 GOTO 810
...
1325 REM EDITS: REPOSITIONED TEXTS - TEXTOS REPOSICIONADOS
1330 DRAW "BM10,88": PRINT #1,"VOCE ACERTOU EM ": DRAW "BM10,100": PRINT #1, CP;"TENTATIVAS"
1340 REM
1350 COLOR 7:DRAW"BM10,118"
1360 DRAW "BM10,118": PRINT #1," QUER RECOMECAR?"
1370 COLOR 11: DRAW"BM10,143": PRINT #1, "SE SIM PRESS. ": DRAW "BM10,155": PRINT #1,"<ESPACO>"
1380 I$=INKEY$
1390 IF I$="" THEN 1380
