...
6500 NEXT J: PRESET(160,24),l: PRINT#1,"1";STRING$(P-2+CH,"0");
...
6810 X=0: FOR J=l TO 9: PRESET(34+(J-1)*16,164),1: A$=RIGHT$(STR$(J),1): PRESET(34+(J-1)*16+4,164),1: PRINT#1,A$: NEXT J: PRESET(34+9*16, 164),1: PRINT#1,"1": PRESET(16*9+34+6,164),1: PRINT#1,"0": PRESET(34+10*16,164),1: PRINT#1,"1"
6811 PRESET(34+10*16+6,164) ,1
6812 PRINT#1,"1": PRESET(11*16+34,164),1: PRINT#1, "l": PRESET(11*16+34+6,164),1: PRINT#1,"2": RETURN
50000 D=34+(J-1)*16: K=160-K: D=D+4: LINE(D-4,K-1)-(D-1,K-7),7: LINE(D+l,K)-(D+5,K-7),7: LINE(D-1,K-7)-(D+5,K-7),7: LINE(D+5,K-7)-(D+5,160),7
50001 RETURN
60000 D=34+(J-1)*16: K=160-K: D=D+10: LINE(D-4,K-1)-(D-1,K-7),7: LINE(D+l,K)-(D+5,K-7),7: LINE(D-1,K-7)-(D+5,K-7),7: LINE(D+5,K-7)-(D+5,160),7
60001 RETURN
